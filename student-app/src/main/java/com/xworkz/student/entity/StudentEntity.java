...
@NamedQueries({
	@NamedQuery(name = "StudentEntity.getByName",query = "from StudentEntity where firstname=:FirstaName"),
	@NamedQuery(name = "StudentEntity.getAll",query = "from StudentEntity"),
	@NamedQuery(name = "StudentEntity.deleteByname",query = "DELETE from StudentEntity where firstname=:FIRSTName")
})
