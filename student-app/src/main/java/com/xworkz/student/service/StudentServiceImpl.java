...
public class StudentServiceImpl implements StudentService {
	...
	public StudentDTO findStudentEntityByStudentName(String studentName) {
		StudentEntity studentEntity = this.studentDAO.findStudentEntityByStudentName(studentName);
	...
	@Override
	public boolean validateDeleteByName(String studentName) {
		boolean flag = false;
		if (studentName != null && !studentName.isEmpty()) {
			flag = true;
			System.out.println("--valid studentName--");
	...
	public boolean deleteByName(String studentName) {
		boolean deleteByName=false;
		 deleteByName = this.studentDAO.deleteByName(studentName);
			return deleteByName;
	}
