...
<body>
<a href="getAllStudentInfo.student"><button class="button">GetAllStudents</button></a>
...
<form action="searchForUpdating.student" method="post">
	<h3 style="color: red">${ErrMsg}</h3>
	<div class="wrapper">
	<input type="text" class="input" 
	...
	<div class="container">
			...
			<label> Firstname: </label> <input type="text" name="firstname" value="${FISRName}"
				placeholder="Firstname"  />
				
				<p style="color: red;">${MNAME}</p>
			<label> Middlename: </label> <input type="text" name="middlename" value="${Middlename}"
				placeholder="Middlename" />
				<p style="color: red;">${LNAME}</p>
			<label> Lastname: </label> <input type="text" name="lastname" value="${Lastname}"
				placeholder="Lastname" />
			<div>
				<p style="color: red;">${COURSE}</p>
				<label> Course : </label> <select name="course"  value="${Course}"> 
			...
			<div>
				...
				<input type="radio" value="Male" name="gender" value="${Gender}" checked> 
	...
	<input
				type="text" name="phone" value="${Phone}" placeholder="phone no." size="10"
			...
			<label for="email"><b>Email</b></label> <input type="text"
				...
				<input type="password"
				placeholder="Enter Password" name="password" value="${Password}" required> <label
				for="psw-repeat"><b>Re-type Password</b></label> <input
				type="password" placeholder="Retype Password" name="pswRepeat" value="${PswRepeat}"
				required>
